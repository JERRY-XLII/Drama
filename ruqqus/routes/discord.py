...
def join_discord(v):
	...
	if v.admin_level == 0 and v.true_score < 100: return "You must earn +100 dramacoins before entering the Discord server. You earn dramacoins by making posts/comments and getting upvoted."
