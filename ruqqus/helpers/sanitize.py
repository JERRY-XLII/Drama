...
def sanitize(text, bio=False, linkgen=False):
	...
	if '" rel="nofollow noopener" target="_blank">https://streamable.com/' in sanitized:
		...
		if bio: htmlsource = f'<div style="padding-top:5px; padding-bottom: 18%;"><iframe style="width: 25%; height: 25%; position: absolute;" allowfullscreen="" frameborder="0" src="{url}"></iframe></div>'
